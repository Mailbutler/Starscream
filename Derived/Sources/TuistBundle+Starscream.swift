...
/// Since Starscream is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "Starscream_Starscream"
        ...
        fatalError("unable to find bundle named Starscream_Starscream")
    }()
}
